...
import { ConcretePokemonPikachu } from "./concretePokemonPikachu"

/**
 * Concrete Creators override the factory method with type ConcreteCreatorElectri
 */
 export class ConcreteCreatorFire extends Creator {
    ...
    public factoryMethod(): ProductPokemon {
        return new ConcretePokemonPikachu(this.name, this.weight, 
